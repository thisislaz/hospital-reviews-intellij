				...
				<div class="container px-6 py-10 mx-auto">
					...
					<div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
						<div class="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group"
							 style="background-image: url('https://source.unsplash.com/random/640x480/?nurse'); background-position: center center; background-blend-mode: multiply; background-size: cover;">
							<div
						...
						<div class="overflow-hidden bg-cover rounded-lg cursor-pointer h-96 group"
							 style="background-image: url('https://source.unsplash.com/random/640x480/?hospital-building'); background-position: center center; background-blend-mode: multiply; background-size: cover;">
							<div
									class="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-800/60 group-hover:opacity-100">
								<h2 class="mt-4 text-xl font-semibold text-white capitalize">Browse our database of US hospitals</h2>
								<p class="mt-2 text-lg tracking-wider text-blue-400 uppercase ">Check out all the reviews we have on hospitals across the US.</p>
							</div>
						</div>
					</div>
				</div>
