	...
	<section class="bg-white dark:bg-gray-900 text-white">
		<div class="max-w-3xl px-6 py-16 mx-auto text-center">
			...
			<section class="flex flex-col mt-8 space-y-3 sm:space-y-0 sm:flex-row sm:justify-center sm:-mx-2 center-form specific-edit">
				<form action="/hospitals/allHospitals" method="get" class="items-center flex flex-col mt-8 space-y-3 sm:space-y-0 sm:flex-row sm:justify-center sm:-mx-2 center-form search-reviews-form">
					...
					<input id="search-review-submit" type="submit" value="Search" class="w-full md:w-fit md:inline md:mx-2 lg:mx-2 my-2 py-2 px-4 font-semibold rounded dark:dark:bg-violet-400 dark:dark:text-gray-900 duration-300 hover:bg-violet-300 hover:cursor-pointer">
				</form>
			</section>
			<!-- Results Section -->
