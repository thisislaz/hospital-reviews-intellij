...
<main>
	<section class="bg-white dark:bg-gray-900 text-white">
		<div class="max-w-3xl px-6 py-16 mx-auto text-center">
			<h1 class="text-3xl font-semibold text-gray-800 dark:text-gray-100"> Search for hospitals by...</h1>
			<p class="max-w-md mx-auto mt-5 text-gray-500 dark:text-gray-400">
				You can search for hospitals to review by hospital attributes. First, choose a search option, then type in its value.
				A list of search results will appear at the bottom of the page, if any hospitals match your search criteria.
			</p>
			<section class="flex flex-col mt-8 space-y-3 sm:space-y-0 sm:flex-row sm:justify-center sm:-mx-2 center-form specific-edit">
				<form action="/hospitals/allHospitals" method="get">
					<select name="searchType" class="md:inline md:w-80 lg:inline lg:w-80 block w-full px-2 mb-3 py-2 text-gray-700 bg-white border rounded-md sm:mx-2 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40">
						<option value="" selected disabled>Please choose from...</option>
						<option value="state">Search by State Abbreviation</option>
						<option value="hospitalName">Search by Hospital Name</option>
						<option value="city">Search by City</option>
					</select>
					<input id="search-review-input" type="text" name="searchValue" placeholder="Enter search value..." class="md:inline md:w-80 lg:inline lg:w-80 block w-full px-2 py-2 text-gray-700 bg-white border rounded-md sm:mx-2 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40">
					<input id="search-review-submit" type="submit" value="Search" class=" block w-full cursor-pointer my-6 px-4 py-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-700 rounded-md sm:mx-2 hover:bg-blue-600 focus:outline-none focus:bg-blue-600">
				</form>
			</section>
			<!-- Results Section -->
			...
			<span class="text-sm font-light text-gray-600 dark:text-gray-400 ">
					There were <c:out value="${fn:length(hospitalList)}"></c:out> results matching your criteria.
			</span>
		</div>
			<c:choose>
				<c:when test="${ not empty hospitalList }">
					<section class="dark:bg-gray-900 w-full px-6 mx-auto text-center h-auto max-h-96 overflow-scroll overflow-x-auto [&::-webkit-scrollbar]:w-2
