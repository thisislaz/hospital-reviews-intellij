		...
		<main class="center-form specific-edit">
			...
			<div id="resultsSection" >
			    <c:choose>
				            ...
				            <tbody>
				                <c:forEach items="${ hospitalList }" var="hospital">
				                    <tr>
				                        ...
				                        <td><c:out value="${ hospital.city }, ${ hospital.state }"></c:out></td>
				                        <td><a class="custom-btn-sq" href="/hospitals/view/${hospital.id}" >View Hospital's Details</a></td>
				                    </tr>
				                </c:forEach>
				            </tbody>
				        </table>
				    ...
				    <c:otherwise>
				        <p>No hospitals found for the provided criteria.</p>
				    </c:otherwise>
				</c:choose>
