				...
				<div class="w-full">
					...
					<form:form action="/user/register" methods="post" modelAttribute="newUser" class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
						<div>
							...
							<form:errors path="firstName" class="ml-2 text-red-500" />
						</div>
						<div>
							...
							<form:errors path="lastName" class="ml-2 text-red-500" />
						</div>
						<div>
							...
							<form:errors path="username" class="ml-2 text-red-500" />
						</div>
						<div>
							...
							<form:errors path="email" class="ml-2 text-red-500"></form:errors>
						</div>
						<div>
							...
							<form:errors path="password" class="ml-2 text-red-500"></form:errors>
						...
						<div>
							...
							<form:errors path="confirm" class="ml-2 text-red-500" />
						</div>
						<button
