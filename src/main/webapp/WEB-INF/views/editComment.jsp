			...
			<article class="max-w-2xl px-6 pt-24 py-8 mx-auto space-y-12 dark:bg-gray-800 dark:text-gray-50 rounded-md">
			    ...
			    <div class="flex flex-col items-center my-4 shadow-md rounded-lg dark:bg-gray-700 w-full max-w-md mx-auto px-6 py-4">
					...
					<input type="hidden" name="_method" value="put" />
						...
						<input type="submit" class="block md:mx-2 lg:mx-2 my-2 py-2 px-4 font-semibold rounded dark:dark:bg-violet-400 dark:dark:text-gray-900 duration-300 hover:cursor-pointer hover:bg-violet-300" value="Edit Comment" />
					</form:form>
			    </div>
			</article>
		</section>
